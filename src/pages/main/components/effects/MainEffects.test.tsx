...
it("MainEffects should change X size", () => {
...
it("MainEffects should change Y size", () => {
  const probe = jest.fn((size) => {
...
it("MainEffects should change Fill factor", () => {
...
it("MainEffects should Run automaton", () => {
  const probe = jest.fn();
  const utils = render(
    <Provider store={store}>
      <AuthProvider>
...
it("MainEffects should Stop automaton", () => {
  const probe = jest.fn();
  const utils = render(
    <Provider store={store}>
      <AuthProvider>
...
it("MainEffects should Clear field", () => {
  const probe = jest.fn();
  const utils = render(
    <Provider store={store}>
      <AuthProvider>
...
it("MainEffects should Fill field", () => {
  const probe = jest.fn();
  const utils = render(
    <Provider store={store}>
      <AuthProvider>
...
// it("MainEffects should fire Tick", () => {
//     const probe = jest.fn();
//     jest.useFakeTimers();
//     const utils = render(
//         <AuthProvider>
...
it("MainEffects should Set Automaton", () => {
...
it("MainEffects should Set Velocity", () => {
...
it("MainEffects should click Cell", () => {
